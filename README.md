...
**Start.java – linija 14** – Unos korisnika ne proverava velika i mala slova → predlog: koristiti `.equalsIgnoreCase("exit")`

---

### Neformalni pregled – Calculator.java

**Calculator.java – linija 17** – Metod `ToString()` vraća operatore bez garantovanog prioriteta → predlog: koristiti strukturu sa redosledom  
**Calculator.java – linija 28** – Izraz `0 + expression` bez navodnika može izazvati grešku → predlog: `"0" + expression`  
**Calculator.java – linija 50** – Preopšta obrada grešaka prilikom parsiranja → predlog: dodati informaciju o grešci ili logovanje  
